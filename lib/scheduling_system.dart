...
class _ScheduleSystemPageState extends State<ScheduleSystemPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Colors.grey[900],
        title: const Text('JAILTRACK', style: TextStyle(color: Colors.white)),
        actions: [
          TextButton(
            onPressed: () {
      ...
      drawer: Drawer(
        child: ListView(
          ...
          children: <Widget>[
            ...
            _drawerItem(
                'icons/dashboardlogo.png', 'Dashboard', DashBoardPage()),
            _drawerItem('icons/notificationlogo.png', 'Notification',
                NotificationPage()),
            _drawerItem('icons/schedlogo.png', 'Scheduling System',
                ScheduleSystemPage()),
            _drawerItem('icons/viewofficerlogo.png', 'View Officers',
                ApproveSchedPage()),
            _drawerItem('icons/officerreqlogo.png', 'Officer Request',
                ApproveSchedPage()),
            _drawerItem(
                'icons/attendancelogo.png', 'Attendance List', DashBoardPage()),
            _drawerItem('icons/settingslogo.png', 'Settings', DashBoardPage()),
          ],
        ),
      ),
      body: Center(
